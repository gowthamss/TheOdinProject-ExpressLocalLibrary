...
exports.book_create_post = [
    ...
    (req, res, next) => {
        // Extract the validatio errors from a request
        const errors = validationResult(req);

        // Create a book object with trimmed and sanitized data
        var book = new Book({
...
exports.book_delete_get = function(req, res, next) {
    async.parallel({
        ...
        function(err, results) {
            ...
            // Check if book instances for a book are present
            if (results.book === null) {
    ...
    async.parallel({
        ...
        function(err, results) {
            ...
            if (results.book_instances.length > 0) {
                // There are book instances, so render same as GET
                res.render('book_delete', { title: 'Delete Book', book: results.book, bookinstances: results.book_instances });
                return;
            } else {
